...
{
	audio_entry = proc_create("asus_audio_status", S_IWUGO| S_IRUGO, NULL, &audio_status_fops);
...
static int tasha_codec_probe(struct snd_soc_codec *codec)
{
	...
	//ASUS_FACTORY+
	if (create_asusproc_audio_status_entry())
...
static int tasha_codec_remove(struct snd_soc_codec *codec)
{
	...
	//ASUS_FACTORY+
	if (audio_entry)
		remove_proc_entry("asus_audio_status", NULL);
	//ASUS_FACTORY-
