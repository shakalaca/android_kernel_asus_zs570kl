...
static const struct snd_kcontrol_new tert_i2s_rx_voice_mixer_controls[] = {
...
static const struct snd_soc_dapm_widget msm_qdsp6_widgets[] = {
	...
	*/
	...
	SND_SOC_DAPM_MIXER("TERT_RX_Voice Mixer",
				SND_SOC_NOPM, 0, 0,
				tert_i2s_rx_voice_mixer_controls,
				ARRAY_SIZE(tert_i2s_rx_voice_mixer_controls)),
...
static const struct snd_soc_dapm_route intercon[] = {
	...
	{"SEC_MI2S_RX", NULL, "SEC_MI2S_RX_Voice Mixer"},
       ...
       {"TERT_RX_Voice Mixer", "CSVoice", "CS-VOICE_DL1"},
       {"TERT_RX_Voice Mixer", "Voice2", "VOICE2_DL"},
       {"TERT_RX_Voice Mixer", "VoLTE", "VoLTE_DL"},
       {"TERT_RX_Voice Mixer", "VoWLAN", "VoWLAN_DL"},
       {"TERT_RX_Voice Mixer", "Voip", "VOIP_DL"},
       {"TERT_RX_Voice Mixer", "DTMF", "DTMF_DL_HL"},
       {"TERT_RX_Voice Mixer", "QCHAT", "QCHAT_DL"},
       {"TERT_RX_Voice Mixer", "VoiceMMode1", "VOICEMMODE1_DL"},
       {"TERT_RX_Voice Mixer", "VoiceMMode2", "VOICEMMODE2_DL"},
       {"TERT_MI2S_RX", NULL, "TERT_RX_Voice Mixer"},
