...
/*
 * Voltage to temperature table for 103AT 10k pull up NTC
 */
static const struct qpnp_vadc_map_pt adcmap_10k_2700_vref[] = {
	{ 2365,	-20 },
	{ 2350,	-19 },
	{ 2335,	-18 },
	{ 2319,	-17 },
		...
		struct qpnp_vadc_result *adc_chan_result)
{
	...
	if (adc_properties->adc_hc) {
		...
		qpnp_adc_map_voltage_temp(adcmap_10k_2700_vref,
			ARRAY_SIZE(adcmap_10k_2700_vref),
