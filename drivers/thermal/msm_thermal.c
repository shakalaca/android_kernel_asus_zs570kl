...
static int __init ktm_params_setup(char *str)
{
	if (str != NULL && !strcmp(str, "255")) {
		pr_info("KTM Disabled at Boot by ASUS\n");
		mitigation = 0;
	}
...
early_param("asus.dbg.thermal_prot_unlock", ktm_params_setup);
