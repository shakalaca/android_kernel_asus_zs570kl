...
int Larua_Read_Calibration_Data_From_File(int16_t *cal_data, uint32_t size){
	...
	if (CSC_mode_flag) {
		status = Sysfs_read_word_seq(CSC_LAURA_CALIBRATION_FACTORY_FILE, buf, size);
	} else {
...
int Olivia_Read_variety_Data_From_File(int16_t *cal_data, uint32_t size){
	int status = 0, i = 0;
	int buf[size];

	////LOG_Handler(LOG_FUN, "%s: Enter\n", __func__);
	if (CSC_mode_flag) {
		status = Sysfs_read_word_seq(CSC_OLIVIA_VARIETY_DATA_FACTORY_FILE, buf, size);
	} else {
		status = Sysfs_read_word_seq(OLIVIA_VARIETY_DATA_FACTORY_FILE, buf, size);
	}
...
int Olivia_Read_TOF_Config_From_File(int16_t *cal_data, uint32_t size){
	int status = 0, i = 0;
	int buf[size];

	////LOG_Handler(LOG_FUN, "%s: Enter\n", __func__);

	status = Sysfs_read_word_seq(OLIVIA_TOF_CONFIG_FACTORY_FILE, buf, size);
...
int Olivia_get_calibration_input(struct seq_file *buf, void *v, 
	...
	seq_printf(buf, "%d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d "
		...
		cal_data_10[0],  cal_data_10[1],  cal_data_10[2],  cal_data_10[3],  cal_data_10[4],  cal_data_10[5],
		cal_data_10[6],  cal_data_10[7],  cal_data_10[8],  cal_data_10[9],  cal_data_10[10], cal_data_10[11],
		cal_data_10[12], cal_data_10[13], cal_data_10[14], cal_data_10[15], cal_data_10[16], cal_data_10[17],
		cal_data_10[18], cal_data_10[19], cal_data_10[20], cal_data_10[21], cal_data_10[22], cal_data_10[23],
		cal_data_10[24], cal_data_10[25], cal_data_10[26],
		cal_data_40[0],  cal_data_40[1],  cal_data_40[2],  cal_data_40[3],  cal_data_40[4],  cal_data_40[5],
		cal_data_40[6],  cal_data_40[7],  cal_data_40[8],  cal_data_40[9],  cal_data_40[10], cal_data_40[11],
		cal_data_40[12], cal_data_40[13], cal_data_40[14], cal_data_40[15], cal_data_40[16], cal_data_40[17],
		cal_data_40[18], cal_data_40[19], cal_data_40[20], cal_data_40[21], cal_data_40[22], cal_data_40[23],
		cal_data_40[24], cal_data_40[25], cal_data_40[26],
		cal_data_inf[0],  cal_data_inf[1],  cal_data_inf[2],  cal_data_inf[3],  cal_data_inf[4],  cal_data_inf[5],
		cal_data_inf[6],  cal_data_inf[7],  cal_data_inf[8],  cal_data_inf[9],  cal_data_inf[10], cal_data_inf[11],
		cal_data_inf[12], cal_data_inf[13], cal_data_inf[14], cal_data_inf[15], cal_data_inf[16], cal_data_inf[17],
		cal_data_inf[18], cal_data_inf[19], cal_data_inf[20], cal_data_inf[21], cal_data_inf[22], cal_data_inf[23],
		cal_data_inf[24], cal_data_inf[25], cal_data_inf[26],
		cal_data_f0[0],  cal_data_f0[1],  cal_data_f0[2],  cal_data_f0[3],  cal_data_f0[4],  cal_data_f0[5],
		cal_data_f0[6],  cal_data_f0[7],  cal_data_f0[8],  cal_data_f0[9],  cal_data_f0[10], cal_data_f0[11],
		cal_data_f0[12], cal_data_f0[13], cal_data_f0[14], cal_data_f0[15], cal_data_f0[16], cal_data_f0[17],
		cal_data_f0[18], cal_data_f0[19], cal_data_f0[20], cal_data_f0[21], cal_data_f0[22], cal_data_f0[23],
		cal_data_f0[24], cal_data_f0[25], cal_data_f0[26], cal_data_f0[27], cal_data_f0[28], cal_data_f0[29],
		cal_data_f0[30], cal_data_f0[31], cal_data_f0[32], cal_data_f0[33], cal_data_f0[34], cal_data_f0[35],
		cal_data_f0[36], cal_data_f0[37], cal_data_f0[38], cal_data_f0[39], cal_data_f0[40], cal_data_f0[41],
		cal_data_f0[42], cal_data_f0[43], cal_data_f0[44], cal_data_f0[45], cal_data_f0[46], cal_data_f0[47],
		cal_data_f0[48], cal_data_f0[49], cal_data_f0[50], cal_data_f0[51], cal_data_f0[52], cal_data_f0[53],
		cal_data_f0[54], cal_data_f0[55], cal_data_f0[56], cal_data_f0[57], cal_data_f0[58] );
	LOG_Handler(LOG_FUN, "%s: Exit\n", __func__);
	return 0;
}

int Laser_get_calibration_input(struct seq_file *buf, void *v, 
	int16_t *cal_data_10, int16_t *cal_data_40,  int16_t *cal_data_f0, uint16_t conf_level_10cm){
	...
	seq_printf(buf, "%d ", conf_level_10cm);
