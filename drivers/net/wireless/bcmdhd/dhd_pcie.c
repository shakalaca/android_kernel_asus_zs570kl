 ...
 *
 * $Id: dhd_pcie.c 640787 2016-05-31 03:13:35Z $
 */
...
#if defined(CUSTOMER_HW_ZEN) && defined(CONFIG_ARCH_MSM) && defined(CONFIG_64BIT)
	/* Read bar1 window */
...
int read_custom_country_code(char *country_code)
{
    ...
    fd = dhd_os_open_image("/factory/PhoneInfodisk/country_code");
...
#if defined(CUSTOMER_HW_ZEN) && defined(CONFIG_ARCH_MSM)
